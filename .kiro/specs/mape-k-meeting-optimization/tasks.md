...
- [ ] 1. ドメイン型定義
- [ ] 1.1 `src/types/meetingOptimization.ts` に MeetingRecord, AgendaRecord, MeetingInsight, LearnedPattern, Suggestion, KnowledgeSettings 型を定義
...
- [ ] 1.2 MeetingKnowledgeState / MeetingKnowledgeActions interface を定義
...
- [ ] 2. Knowledge Store 実装 (P)
- [ ] 2.1 `src/features/timer/stores/meeting-knowledge-store.ts` を作成
...
- [ ] 3. Meeting Optimization Service 実装 (P)
- [ ] 3.1 `src/features/timer/services/meeting-optimization-service.ts` を作成
...
- [ ] 3.3 提案生成ロジック
  ...
  - 最低 3 件のデータがないと提案なし
  - _Requirements: 3_
- [ ] 3.4 公開 API: getSuggestionsForAgenda 関数
